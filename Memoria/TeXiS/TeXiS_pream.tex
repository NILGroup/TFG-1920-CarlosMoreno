...
% Redefino los colores con los que lstlisting muestra código python
%http://latexcolor.com/
\definecolor{deepblue}{rgb}{0.01,0.28,1}
\definecolor{deepred}{rgb}{1,0.1,0.26}
\definecolor{deepgreen}{rgb}{0,0.6,0}
\definecolor{mybronze}{rgb}{0.8,0.5,0.2}
\definecolor{mymauve}{rgb}{0.58,0,0.82}
\definecolor{mygray}{rgb}{0.5,0.5,0.5}

%https://en.wikibooks.org/wiki/LaTeX/Source_Code_Listings
% Python style for highlighting
\newcommand\pythonstylenum{\lstset{
		language=Python,
		basicstyle=\small,
		commentstyle=\color{deepgreen},
		otherkeywords={self},             % Add keywords here
		keywordstyle=\bfseries\color{deepblue},
		emph={auth,__init__,get_credentials, None, open},          % Custom highlighting
...
\newcommand\pythonstyle{\lstset{
		...
		otherkeywords={self},             % Add keywords here
		keywordstyle=\bfseries\color{deepblue},
		emph={auth,__init__,get_credentials},          % Custom highlighting
		emphstyle=\color{deepred},    % Custom highlighting style
		numberstyle=\color{mygray},
		stringstyle=\color{mymauve},
		showstringspaces=false,            %
