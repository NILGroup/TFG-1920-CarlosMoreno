...
\ifpdf\hypersetup{%
    pdftitle = {\titulo},
    pdfsubject = {Memoria de TFG},
    pdfkeywords = {Memoria, LaTeX, TFG, IRIS, trabajo de Grado},
...
\include{Capitulos/UsedTech}
\include{Capitulos/DescripcionTrabajo}
\include{Capitulos/StyleAnalysis}
\include{Capitulos/Generacion}
