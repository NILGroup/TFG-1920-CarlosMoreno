...
One factor to be taken into account is the limitations of the Gmail API which could become a drawback in the application development. It has a limit on the daily usage and on the per-user rate. However, both are acceptable for the type of software we want to build on: 1,000,000,000 quota units per day and 250 quota units per user per second.
