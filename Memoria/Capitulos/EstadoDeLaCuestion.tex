...
Regardless of which programming language is used, message resource \citep[/v1/reference/users/messages]{gmailAPI} internally has a dictionary structure. The more important (for us) keys of this data structure are (at least the most useful keys for our purpose):
\begin{itemize}
