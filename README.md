...
+ drafts_main.py: utilizando la clase _drafts_ y _auth_ , inicia una sesión y crea dos borradores prestablecidos por defecto. Después lista los borradores del usuario para comprobar que la operación se ha realizado con éxito.
